...
func (c *Finder) PreExecute(command []string) (*dcSDK.BKDistCommand, int, error) {
...
func (c *Finder) OnRemoteFail(command []string) (*dcSDK.BKDistCommand, int, error) {
...
func (c *Finder) PostExecute(r *dcSDK.BKDistResult) (int, error) {
