...
// PreExecute 预处理
func (cl *TaskCL) PreExecute(command []string) (*dcSDK.BKDistCommand, int, error) {
...
func (cl *TaskCL) OnRemoteFail(command []string) (*dcSDK.BKDistCommand, int, error) {
...
// PostExecute 后置处理
func (cl *TaskCL) PostExecute(r *dcSDK.BKDistResult) (int, error) {
